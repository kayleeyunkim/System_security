...
CREATE TABLE Comp424.students (userid INT AUTO_INCREMENT primary key,today INT,username TEXT, fname TEXT, lname TEXT, email TEXT, birthday DATE, userpass TEXT);
SHOW TABLES;
\q;
EOF