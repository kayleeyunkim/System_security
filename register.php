...
>>>>>>> 4bfa20cf608b9078a6e9c83dfa1489525e31d9db
...
=======
            ...
            <select class="security_question" id="security_question" name="sec_que">
                <option value="">Select Security Question</option>
                <option value="pet_name">What is your pet name?</option>
                <option value="univ_name">Which college did you go to?</option>
                <option value="grad_year">What year did/will you graduate?</option>
                <option value="preferos">Which OS do you prefer?</option>
                <option value="vacation">Where do you want to go for your vacation?</option>
            </select>
            <input type="text" class="register" name="answer" placeholder="Type answer here">
        </div>
        <div class="submit_div">
            <input type="submit" name="submit" value="Register" class="submit">
            <span class=error> <?php echo "</br><div style='text-align: center'>$errorempty</div>" ?></span>
